...
"""QMIX 4m_vs_3m"""
test1.load_state_dict(torch.load(r"./model/qmix/3m/rnn_net_params.pkl", map_location='cuda:0'))
x = torch.rand(64, 6)
test1.fc1.weight = torch.nn.Parameter(
                    torch.cat((test1.fc1.weight, x), dim=1))
# #修改代码
# x1 = test1.fc1.weight[:,:29]
# #因为队友增加的信息
# x2= test1.fc1.weight[:,24:29]
# #剩余不变信息
# x3 = test1.fc1.weight[:,29:]
# #最后额外增加的信息
...
torch.save(test1.state_dict(), './model//qmix/4m_vs_3m/rnn_net_params_ran.pkl')
...
"""VDN 4m_vs_3m"""
# test1.load_state_dict(torch.load(r"./model/vdn/3m/rnn_net_params.pkl", map_location='cuda:0'))
# # #修改代码
# x1 = test1.fc1.weight[:,:29]
# #因为队友增加的信息
# x2= test1.fc1.weight[:,24:29]
...
#                     torch.cat((test1.fc1.weight, x4), dim=1))
#
# torch.save(test1.state_dict(), './model//vdn/4m_vs_3m/vdn_net_params.pkl')
"""VDN 2m_vs_3m"""
# x1 = test1.fc1.weight[:,:24]
# #因为队友增加的信息
# x2= test1.fc1.weight[:,29:41]
...
"""QTRAN 4m_vs_3m"""
# test1.load_state_dict(torch.load(r"./model/qtran_base/3m/rnn_net_params.pkl", map_location='cuda:0'))
# # #修改代码
# x1 = test1.fc1.weight[:,:29]
# #因为队友增加的信息
# x2= test1.fc1.weight[:,24:29]
...
#                     torch.cat((test1.fc1.weight, x4), dim=1))
#
# torch.save(test1.state_dict(), './model//qtran_base/4m_vs_3m/rnn_net_params.pkl')

"""COMA 4m_vs_3m"""
# test1.load_state_dict(torch.load(r"./model/coma/3m/rnn_params.pkl", map_location='cuda:0'))
# # #修改代码
# x1 = test1.fc1.weight[:,:29]
# #因为队友增加的信息
# x2= test1.fc1.weight[:,24:29]
...
#                     torch.cat((test1.fc1.weight, x4), dim=1))
#
# torch.save(test1.state_dict(), './model//coma/4m_vs_3m/rnn_params.pkl')
...
#
# test1.load_state_dict(torch.load(r"./model/reinforce+g2anet/3m/rnn_params.pkl", map_location='cuda:0'))
# # #修改代码
# x1 = test1.encoding.weight[:,:29]
# #因为队友增加的信息
# x2= test1.encoding.weight[:,24:29]
...
#                     torch.cat((test1.encoding.weight, x4), dim=1))
#
# torch.save(test1.state_dict(), './model//reinforce+g2anet/4m_vs_3m/rnn_params.pkl')
...
test1 = BootstrappedRNN(42,64,16,3,9)

test1.load_state_dict(torch.load(r"./model/maven/3m/rnn_net_params.pkl", map_location='cuda:0'))
#修改代码
x1 = test1.fc.weight[:,:29]
#因为队友增加的信息
x2= test1.fc.weight[:,24:29]
#剩余不变信息
x3 = test1.fc.weight[:,29:]
#最后额外增加的信息
...
torch.save(test1.state_dict(), './model//maven/4m_vs_3m/rnn_net_params.pkl')